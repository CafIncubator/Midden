...
dotnet publish -c Release -o Publish/osx.10.11-x64 -p:PublishReadyToRun=false -p:PublishSingleFile=true --self-contained true -p:IncludeNativeLibrariesForSelfExtract=true -r osx.10.11-x64 /p:DebugType=None /p:DebugSymbols=false
